...
from referentielijsten_api_client.typing import (
    ErrorResponseBody,
    InvalidParam,
...
class ReferentielijstenClientException(Exception):
    """Base exception for all client-related errors."""

    pass


class ResponseError(ReferentielijstenClientException):
...
class BadRequest(ClientError):
    ...
    def __init__(self, response: Response, body: ValidationErrorResponseBody):
        ...
        ReferentielijstenClientException.__init__(self, msg)
